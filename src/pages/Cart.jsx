...
const Cart = ({ cart, setCart }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 p-6 text-white min-h-screen mt-10">
      ...
      <div className="w-full md:w-[55%]">
        {cart.length !== 0 ? (
          cart.map((item) => (
            <div
              key={item.id}
              className="flex flex-col md:flex-row justify-center items-center gap-6 p-4 bg-zinc-800 rounded-md my-3"
            >
              <img
                src={item.images[0]}
                alt={item.title}
      ...
      <div className="w-full md:w-[25%] bg-zinc-900 p-6 rounded-xl h-fit my-3 ">
